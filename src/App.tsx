...
const ownerPng = '/src/assets/images/owner_afsar_1780672573281.png';

// Authentic Hindu & Muslim customer reviews reflecting Lucknow clientele
const customerReviews = [
  {
    ...
    reviewEn: "Met Mr. Afsar directly and got an amazing deal on a Classic 350. Transparency at its best. The registration transfer was handled completely by them automatically within 7 days. Best pre-owned bike showroom in Lucknow!",
    reviewHi: "अफ़सार जी से मिलकर सीधे बातचीत हुई और बुलेट 350 पर बेहतरीन डील मिली। लखनऊ का सबसे पारदर्शी और ईमानदार शो-रूम। आरसी ट्रांसफर की जिम्मेदारी शोरूम ने खुद लेकर 7 दिन में काम पूरा करा दिया।"
  },
  {
    id: 2,
    name: "Mohammad Anas",
    ...
    rating: 5,
    bike: "Yamaha R15 V4",
    reviewEn: "I was highly skeptical about buying a second hand sports bike, but Afsar Auto Sales gave me a fully certified bike with 45 mechanical checks points. Absolutely satisfied with the transparent engine report offered.",
    reviewHi: "सेकंड हैंड स्पोर्ट्स बाइक लेने में काफी संकोच था, पर अफ़सार ऑटो सेल्स पर मुझे 45 पॉइंट्स मैकेनिकली सर्टिफाइड यामाहा मिली। इंजन रिपोर्ट और पारदर्शी बातचीत से पूरी तरह से संतुष्ट हूँ।"
  },
  {
    id: 3,
    name: "Anjali Mishra",
    ...
    reviewEn: "Bought an Activa 6G for my daily office commute. The pricing was completely direct and without any hidden middleman charges. Mr. Afsar personally verified the battery and double-checked the brakes before delivery.",
    reviewHi: "रोजाना ऑफिस जाने के लिए एक्टिवा 6G खरीदी। बिना किसी दलाली या छिपे हुए खर्च के सीधे मालिक वाली डील मिली। अफ़सार जी ने खुद गाड़ी की बैटरी और नए ब्रेक चेक कर डिलीवरी दी।"
  },
  {
    id: 4,
    ...
    rating: 5,
    bike: "KTM Duke 250",
    reviewEn: "The collection here is genuinely superior and very clean. Got a mint condition KTM Duke 250. Trustworthy documents, verified insurance, and Mr. Afsar's welcoming demeanor makes this the place to buy bikes.",
    reviewHi: "यहाँ उपलब्ध गाड़ियों का कलेक्शन वाकई बहुत शानदार और साफ़-सुथरा है। बिल्कुल ब्रांड न्यू जैसी हालत में KTM ड्यूक मिली। सारे कागजात पक्के और अफ़सार भाई का व्यवहार बहुत ही बढ़िया है।"
  }
];
          ...
          >
            ...
            <div className="text-center max-w-3xl mx-auto mb-16 animate-fade-in">
              <span className="inline-flex items-center gap-1.5 bg-amber-500/10 border border-amber-500/30 px-3.5 py-1.5 rounded-full text-amber-500 dark:text-amber-400 text-xs font-bold uppercase tracking-wider mb-5">
                ...
                <span>{lang === 'en' ? 'Established Since 2001' : 'साल 2001 से स्थापित'}</span>
              </span>
              ...
              <p className="text-gray-500 dark:text-zinc-400 text-sm sm:text-base leading-relaxed">
                {lang === 'en'
                  ? 'More than just a dealership—we are Lucknow\'s gold standard for premium selected certified pre-owned bikes for over 2.5 decades.'
                  : 'सिर्फ एक डीलरशिप नहीं - हम ढाई दशकों से लखनऊ में प्रीमियम चुनी हुई और प्रमाणित सेकंड-हैंड बाइकों के नंबर वन विश्वसनीय शोरूम हैं।'}
              </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
              {[
                { label: lang === 'en' ? 'Years Of Trust' : 'वर्षों का अटूट विश्वास', val: "25+", icon: <Award className="text-amber-500" /> },
            ...
            <div className="p-8 rounded-3xl bg-white dark:bg-zinc-900 border border-gray-150 dark:border-zinc-800 shadow-xs mb-16 flex flex-col md:flex-row gap-8 items-center">
              <div className="w-40 h-40 sm:w-48 sm:h-48 rounded-2xl overflow-hidden shrink-0 border-4 border-amber-500 shadow-lg">
                <img
                  src={ownerPng}
                  alt="Afsar - Owner of AFSAR Auto Sales"
                  referrerPolicy="no-referrer"
              ...
              <div className="space-y-3 flex-1 text-center md:text-left">
                ...
                <p className="text-sm font-semibold text-gray-400 dark:text-zinc-500">
                  {lang === 'en' ? 'Pioneering Trust in Pre-Owned Vehicles Since 2001' : 'साल 2001 से पुरानी गाड़ियों में लखनऊ का नंबर 1 भरोसा'}
                </p>
                <p className="text-sm text-gray-550 dark:text-zinc-400 leading-relaxed italic">
                  {lang === 'en'
                    ? '"At AFSAR Auto Sales, our principle is simple: transparent direct dealings (P2P) and thorough verification. Every ride has a story, and we guarantee that yours will be secure, smooth, and highly satisfying. Come visit our store and test drive your dream bike today!"'
                    : '"अफ़सार ऑटो सेल्स में, हमारा सीधा और सरल सिद्धांत है: प्रत्यक्ष एवं पारदर्शी लेन-देन और गाड़ियों की पूर्ण मैकेनिक जांच। हर राइड की अपनी एक कहानी होती है, और हम गारंटी देते हैं कि आपका सफर सुरक्षित, आसान और सुखद होगा। शोरूम आकर सीधे अपनी पसंदीदा बाइक का अनुभव लें।"'}
                </p>
              </div>
            </div>

            {/* Testimonials Slider */}
            <div className="mb-16 bg-gradient-to-br from-amber-500/[0.02] to-yellow-500/[0.04] dark:from-zinc-900/60 dark:to-zinc-850/60 border border-gray-150 dark:border-zinc-800 rounded-3xl p-8 shadow-xs relative overflow-hidden">
              ...
              <div className="min-h-[220px] sm:min-h-[160px] flex items-center justify-center">
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    {/* Review text */}
                    <p className="text-base sm:text-lg text-gray-750 dark:text-zinc-200 leading-relaxed font-sans font-medium italic">
            ...
            <div className="p-8 rounded-3xl bg-amber-500/[0.03] dark:bg-amber-500/[5%] border border-amber-500/20 dark:border-amber-500/10 text-center shadow-xs">
              ...
              <p className="text-gray-500 dark:text-zinc-400 text-xs sm:text-sm max-w-xl mx-auto mb-8 leading-relaxed">
                {lang === 'en' 
              ...
              <div className="flex flex-wrap items-center justify-center gap-3.5">
                <a
                  href="https://wa.me/918318914223?text=Hello%20AFSAR%20Auto%20Sales,%20I%20am%20interested%20in%20knowing%20about%20your%20latest%20bike%20arrivals."
                  target="_blank"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 px-5 py-3 bg-red-600 hover:bg-red-750 text-white font-extrabold text-xs rounded-xl shadow-md transition-all cursor-pointer"
                >
                  <Youtube size={16} />
                  <span>YouTube</span>
                </a>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
                      ...
                      <div className="flex gap-4 items-start">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex flex-wrap gap-2.5">
                            ...
                            <a
                              href="https://wa.me/918318914223?text=Hello%20AFSAR%20Auto%2520Sales,%20I%20am%20interested%20in%20checking%20out%20your%20available%20bike%20inventory."
                              target="_blank"
                              rel="noopener noreferrer"
                  ...
                  <div className="lg:col-span-7 rounded-3xl overflow-hidden border border-gray-150 dark:border-zinc-800 bg-white dark:bg-zinc-900 shadow-xs flex flex-col h-full min-h-[350px]">
                    ...
                    <div className="flex-1 relative w-full h-full min-h-[325px]">
                      <iframe
                        title="AFSAR Auto Sales Store Location Map"
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3558.9941271852917!2d80.95414487522291!3d26.8719276766715!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x399bfd6f7eff72af%3A0x49df7987c5504f9e!2sAFSAR%20Auto%20Sales!5e0!3m2!1sen!2sin!4v1780672115794!5m2!1sen!2sin"
      ...
      <footer className="bg-white dark:bg-zinc-900 border-t border-gray-100 dark:border-zinc-800/80 mt-16 transition-colors">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 flex flex-col sm:flex-row items-center justify-between gap-6 text-xs text-gray-400 dark:text-zinc-400">
          <div className="flex flex-col gap-1 sm:text-left text-center">
            ...
            <span>&copy; {new Date().getFullYear()} AFSAR Auto Sales. {lang === 'en' ? 'All rights reserved.' : 'सर्वाधिकार सुरक्षित।'}</span>
            <span className="text-[10px] text-gray-400">{lang === 'en' ? 'Established Since 2001 (25 Years of Trust)' : 'साल 2001 से स्थापित (25 वर्षों का अटूट विश्वास)'}</span>
          </div>
          
          {/* Social Media Links in Footer */}
          <div className="flex items-center justify-center gap-4">
            <a
              href="https://wa.me/918318914223"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="p-2.5 rounded-xl bg-gray-50 dark:bg-zinc-800/60 hover:bg-blue-600 hover:text-white dark:hover:bg-blue-750 dark:hover:text-white text-blue-600 dark:text-indigo-400 transition-all shadow-xs border border-gray-200/50 dark:border-zinc-800/40 cursor-pointer"
